...
-(void)notice:(NSNotification *)notification {
    ...
    if (naviDic[@"titleBar"]) {
        ...
        if (titleBarDic.allKeys.count<=0) {
           ...
           self.navigationController.navigationBar.barTintColor =[UIColor colorWithHexString:@"#ffab03"] /*[CommonUtil getColor:naviDic[@"titleBar"][@"backgroundColor"]]*/;
...
//    [self.view addSubview:self.stateView];
    ...
    self.navigationController.navigationBar.barTintColor =[UIColor colorWithHexString:@"#ffab03"] ;
